...
class Wellington_Magazine_Posts_Columns_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => esc_html__( 'Displays your posts from two selected categories.', 'wellington' ),
	...
	private function default_settings() {
		...
		$defaults = array(
			'category_one'       => 0,
			'category_two'       => 0,
			'category_one_title' => esc_html__( 'Left Category', 'wellington' ),
			'category_two_title' => esc_html__( 'Right Category', 'wellington' ),
			'number'             => 4,
			'highlight_post'     => true,
		);
