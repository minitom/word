...
function wellington_customize_preview_js() {
	wp_enqueue_script( 'wellington-customizer-preview', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20170806', true );
}
...
function wellington_customize_preview_css() {
	wp_enqueue_style( 'wellington-customizer-css', get_template_directory_uri() . '/css/customizer.css', array(), '20170806' );
}
